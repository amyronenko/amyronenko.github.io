    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            ...
            if (!data.vals) {
                ...
                data.width = Math.round((data.fontSize * 0.5) + (data.height * 0.13)) || data.width;
                ...
                dot2 = '';
                maxWidth = Math.round((data.width * 4) + 10);
                ...
                thtml = (data.displayCaptions
                    ? (data.displayHours
                            ? '<figure style="width:25%">$1<figcaption' + fsStyle + '>'
                                + language.hours + '</figcaption></figure>' + dot2
                            : '')
                        + '<figure style="width:25%">$1<figcaption' + fsStyle + '>' + language.min
                        + '</figcaption></figure>' + dot2
                        + '<figure style="width:25%">$1<figcaption' + fsStyle + '>' + language.sec
                        + '</figcaption></figure>'
                    : (data.displayHours ? '$1' + dot2 : '') + '$1' + dot2 + '$1'
                ).replace(/\$1/g, dhtml1 + dhtml2);

                if (data.displayDays > 0) {
                    marginRight = data.fontSize * 0 || defaults.gap;
                    dhtml = dhtml1;
                    ...
                    // thtml = (data.displayCaptions
                    //     ? '<figure style="width:' + Math.round((data.width * data.displayDays) + marginRight + 10) + 'px">$1'
